...
// character of length 3 unless it is followed by {N} which represents how many characters should appear in the sequence where N 
// will be at least 1.
...
console.log(StringChallenge("**+*{5} mmmrrrkbb")); //true
